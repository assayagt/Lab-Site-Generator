        ...
        try:
            ...
            for participant in participants:
                ...
                if not email or not full_name or not degree:
                    return jsonify(
                        {"error": "All participants must have an email, full name, and degree.", "response": "false"})
            ...
            try:
                ...
                if response.is_success():
                    ...
                    if response2.is_success():
                        response3 = generator_system.set_site_contact_info_on_creation_from_generator(domain,
                                                                                                      contact_info)
...
if __name__ == '__main__':
    ...
    socketio.run(app, host='0.0.0.0', port=5000)    ##app.run(debug=True)
