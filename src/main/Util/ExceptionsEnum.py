...
class ExceptionsEnum(Enum):
    ...
    USER_IS_NOT_A_LAB_MANAGER_OR_CREATOR = "Attention! this operation is saved for lab managers only"
    USER_IS_NOT_A_LAB_MEMBER_OR_LAB_MANAGER = "User is not a lab member or a lab manager"
    USER_IS_NOT_A_LAB_MEMBER_OR_LAB_MANAGER_OR_CREATOR = "Attention! this operation is saved for lab members only"
    ...
    PUBLICATION_ALREADY_REJECTED = "ERROR: Publication already rejected, and may appear on your rejected publications list"
