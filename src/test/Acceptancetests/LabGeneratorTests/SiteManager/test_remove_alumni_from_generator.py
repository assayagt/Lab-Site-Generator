...
class TestAddAlumniFromGenerator(unittest.TestCase):
    def setUp(self):
        ...
        self.generator_system_service.add_alumni_from_generator(self.manager_user_id, "member1@example.com", self.domain)
    ...
    def test_register_new_lab_member_success(self):
        ...
        response = self.generator_system_service.remove_alumni_from_generator(self.manager_user_id, "member1@example.com", self.domain)
